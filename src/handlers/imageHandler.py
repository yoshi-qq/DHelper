...
class ImageHandler:
    ...
    def createItemCard(self, item: Item) -> None:
        ...
        def addStatsrmation(background: Image.Image, weight: float, damage: Optional[Damage], attributes: list[AttributeType]) -> None:
            rows: list[str] = []
        ...
        addStatsrmation(cardImage, item.weight, item.damage, item.attributes)
